...
import { ProviderServiceDocument,ProviderServiceModel } from "../models/provider-service.model";
  ...
  implements IProviderServiceRepository
{
  ...
  //   const raw = await this.model.aggregate<ProviderServicesGroupedData>([
  //     // pipeline
  //     {
  //       $match: {
  //         providerId: new Types.ObjectId(providerId),
