...
const statusStyles: Record<Status, string> = {
  ...
  "provider completed" :     "bg-warning/10 text-warning border-warning/20 shadow-sm shadow-warning/5",
  "client completed" :     "bg-warning/10 text-warning border-warning/20 shadow-sm shadow-warning/5",
