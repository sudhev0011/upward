...
export const RECOMMENDATIONS: Recommendation[] = [
  { id: "r1", title: "AC Maintenance",       provider: "Cool Fix Pro",  providerInitials: "CF", category: "Onsite",  rating: 4.9, reviews: 312, price: "From $89",  badge: "Top Rated" },
  { id: "r2", title: "SEO Consulting",       provider: "Rank Studio",   providerInitials: "RS", category: "Offsite", rating: 4.8, reviews: 198, price: "From $120/h" },
  { id: "r3", title: "Interior Painting",    provider: "BrushWorks",    providerInitials: "BW", category: "Onsite",  rating: 4.7, reviews: 445, price: "From $150",  badge: "Popular" },
  { id: "r4", title: "Mobile App Dev",       provider: "AppCraft",      providerInitials: "AC", category: "Offsite", rating: 4.9, reviews: 87,  price: "From $80/h",  badge: "New" },
];
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {r.badge && (
                <span className={`rounded-full px-2 py-0.5 text-[10px] font-bold ${BADGE_STYLES[r.badge] ?? ""}`}>
                  {r.badge}
                </span>
              )}
            </div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <span className={`rounded-full px-2 py-0.5 text-[11px] font-semibold ${CATEGORY_STYLES[r.category]}`}>
                {r.category}
              </span>
