        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-gray-400 mb-6 max-w-[220px]">
              Your go-to platform for onsite &amp; offsite services. Connect
              with skilled professionals to get the job done right.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-2.5">
                <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#719FC4]/15 text-[#719FC4]">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#719FC4] text-white transition-all duration-200 hover:bg-[#5585A8] hover:shadow-md">
