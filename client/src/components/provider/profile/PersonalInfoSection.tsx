...
export function PersonalInfoSection() {
  const {
    ...
    setValue,
    formState: { errors },
  } = useFormContext<ProviderProfileFormData>();
      ...
      <CardContent className="space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              disabled
              {...register("email")}
              className="bg-secondary/30 border-border/50 rounded-xl focus:border-primary/50 transition-colors opacity-70 cursor-not-allowed"
            />
            {errors.email && (
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                      className={cn(
                        "w-full justify-start text-left font-normal bg-secondary/30 border-border/50 rounded-xl hover:bg-secondary/40",
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            className="bg-secondary/30 border-border/50 rounded-xl min-h-[100px] focus:border-primary/50 transition-colors"
          />
          {errors.bio && (
